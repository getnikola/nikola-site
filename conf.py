...
CONTENT_FOOTER = '''Contents © 2012–2025 <a href="/contact.html">Roberto Alsina and the Nikola contributors</a>&nbsp;&nbsp;|&nbsp;&nbsp;Powered by Nikola itself&nbsp;&nbsp;|&nbsp;&nbsp;
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        (
            (
                ('https://github.com/getnikola/nikola/issues', 'GitHub Issues'),
                ('https://github.com/getnikola/nikola/discussions', 'GitHub Discussions'),
                ('https://x.com/GetNikola', 'X/Twitter'),
